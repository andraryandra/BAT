        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title btn btn-success">Import New Users</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form id="upload_form" action="{{ route('create-user.importUsers') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <table id="example"  class="table text-center table-responsive table-striped table-bordered mt-5" style="width:100%;">
            <thead style="font-size: 11px;" class="bg-warning">
                <tr>
                    ...
                    <th class="" width="20"></th>
                    <th class="col">Users Employe ID</th>
                    <th class="col">Users First Name</th>
                    <th class="col">Users Last Name</th>
                    <th class="col">Users Name</th>
                    <th class="col">Users Role Name</th>
                    <th class="col">Users Status Name</th>
                    <th class="col">Users Email</th>
                    <th class="col">Users Address</th>
                    <th class="col">Users Phone</th>
                    <th class="col">Users Type</th>
                </tr>
            </thead>
            <tbody style="font-size: 13px;">
                ...
                <tr>
                    ...
                    <td>{{ $user->users_employe_id }}</td>
                    <td>{{ $user->users_first_name }}</td>
                    <td>{{ $user->users_last_name }}</td>
                    <td>{{ $user->users_users_name }}</td>
