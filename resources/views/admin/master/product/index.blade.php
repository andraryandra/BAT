        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title btn btn-success">Import Product</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form id="upload_form" action="{{ route('product.importProduct') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <table id="example"  class="table text-center table-responsive table-striped table-bordered mt-5" style="width:100%;">
            <thead style="font-size: 11px;" class="bg-warning">
                <tr>
                    ...
                    <th class="col">Product Status</th>
                    <th class="col">Product Manufacture</th>
                    <th class="col">Product Category</th>
                    <th class="col">Product Start Date</th>
                    <th class="col">Product End Date</th>
                </tr>
            </thead>
            <tbody style="font-size: 13px;">
                ...
                <tr>
                    ...
                    <td>{{ $product->product_end_date }}</td>
